...
export const codexAdapter: TargetAdapter = {
  ...
  classifyPath(candidatePath) {
    return classifyByRules(candidatePath, [
      ...
      [/^config\.toml$/, role("native-owned", "user-config", 0.9)],
